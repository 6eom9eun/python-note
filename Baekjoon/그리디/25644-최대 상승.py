...
ANA 회사의 앞으로 N일간의 주가를 a1,a2,...,aN이라고 하자. 정균이가 i번째 날에 주식을 사고, j번째 날에 판다면 aj-ai만큼의 이득을 얻을 수 있다. 
...
입력
첫째 줄에 정수 N(1<=N<=200000)이 주어진다.

두 번째 줄에 정수 
a1,a2,...,aN이 주어진다. ai(1<=ai<=10^9)는 i번째 날의 ANA 회사의 주가이다.
